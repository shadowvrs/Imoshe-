#To run in a terminal - python3 PythonImosheGraphics.py
from tkinter import *
...
def Set():
    ...
    if ThemeSave == "Dark":
        backr = "gray"
        textColorChose = "white"
        Input.configure(bg = inputsColorB, fg = inputsColorT)
    elif ThemeSave == "Darker":
        backr = "black"
        textColorChose = "white"
        Input.configure(bg = inputsColorB, fg = inputsColorT)
        ...
        Input.configure(bg = inputsColorT, fg = inputsColorB)
...
def settings():
    ...
    settingsTheme.place(relx = 0.151, rely = 0.18, anchor = "w")
    fontText.place(relx = 0.153, rely = 0.3, anchor = "w")
    fonts.place(relx = 0.17, rely = 0.36, anchor = "w")
...
#Buttons
newImoshe = Button(root, text = "Imoshe Translate", font = (fontChange, 15), padx = 25, command = ImosheUI)
backwardsTextB = Button(root, text = "Backwards Text", font = (fontChange, 15), padx = 20, command = backwardsTextPut)
settingsb = Button(root, text = "Settings", font = (fontChange, 15), padx = 40, command = settings)
exitButton = Button(root, text = "Exit", fon = (fontChange, 15), padx = 40, command = root.quit)
save = Button(root, text = "Save", font = (fontChange, 15), padx = 30, pady = 10, command = Set)
back = Button(root, text = "Back", font = (fontChange, 15), padx = 30, pady = 10, command = Menu)
convert = Button(frameImosheCon, text = "Convert", font = (fontChange, 15), padx = 25, pady = 8, command = resultNewImosheTrans)
convertBTButton = Button(frameBackwardsText, text = "Convert", font = (fontChange, 15), padx = 25, pady = 8, command = lambda: convertBackwardsText())

#Options
theme = OptionMenu(root, WhichTheme, "Darker", "Dark", "Light")
